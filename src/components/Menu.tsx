...
export default function Menu() {
  ...
  const currentCocktail: Cocktail = getCocktailAt(0);
  const prevCocktail: Cocktail = getCocktailAt(-1);
  const nextCocktail: Cocktail = getCocktailAt(1);
  ...
  return (
    <section id="menu" aria-labelledby="menu-heading">
      ...
      <nav className="cocktail-tabs" aria-label="Cocktail Navigation">
        {sliderLists.map((cocktail: Cocktail, index: number) => {
